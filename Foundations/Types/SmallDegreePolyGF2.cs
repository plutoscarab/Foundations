...
namespace Foundations.Types
{
    ...
    /// </summary>
    public partial struct SmallDegreePolyGF2
    {
        /// <summary>
        /// Constant value 0.
        /// </summary>
        public static readonly SmallDegreePolyGF2 Zero = new SmallDegreePolyGF2(0UL);

        /// <summary>
        /// Constant value 1.
        /// </summary>
        public static readonly SmallDegreePolyGF2 One = new SmallDegreePolyGF2(1UL);

        /// <summary>
        /// The degree of the polynomial.
        /// </summary>
        public int Degree => Coefficients == 0 ? 0 : Bits.FloorLog2(Coefficients);

        /// <summary>
        /// Number of terms in the polynomial.
        /// </summary>
        public int TermCount => Bits.Count(Coefficients);

        /// <summary>
        /// Creates a <see cref="SmallDegreePolyGF2"/>. 
        /// </summary>
        /// <param name="exponents">The exponents of terms with non-zero coefficient.</param>
        public SmallDegreePolyGF2(params int[] exponents)
        {
